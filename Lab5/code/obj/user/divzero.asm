...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800038:	56450513          	addi	a0,a0,1380 # 800598 <main+0x72>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80005a:	56250513          	addi	a0,a0,1378 # 8005b8 <main+0x92>
...
exit(int error_code) {
  ...
  800128:	49c50513          	addi	a0,a0,1180 # 8005c0 <main+0x9a>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80017c:	46078793          	addi	a5,a5,1120 # 8005d8 <main+0xb2>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001d4:	530a8a93          	addi	s5,s5,1328 # 800700 <main+0x1da>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8003f6:	46678793          	addi	a5,a5,1126 # 800858 <error_string>
  ...
  80040a:	20260613          	addi	a2,a2,514 # 800608 <main+0xe2>
  ...
  80041c:	1e060613          	addi	a2,a2,480 # 8005f8 <main+0xd2>
  ...
  80048e:	167d8d93          	addi	s11,s11,359 # 8005f1 <main+0xcb>
  ...
  8004ca:	12a50513          	addi	a0,a0,298 # 8005f0 <main+0xca>
  ...
  8004de:	116d8d93          	addi	s11,s11,278 # 8005f0 <main+0xca>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
main(void) {
  ...
  800530:	e406                	sd	ra,8(sp)
    if (b == 0) {
  800532:	c729                	beqz	a4,80057c <main+0x56>
    return a / b;
  800534:	0017079b          	addiw	a5,a4,1
  800538:	0037b793          	sltiu	a5,a5,3
  80053c:	4581                	li	a1,0
  80053e:	ef85                	bnez	a5,800576 <main+0x50>
    cprintf("value is %d.\n", safe_div(1, zero));
  800540:	00000517          	auipc	a0,0x0
  800544:	19050513          	addi	a0,a0,400 # 8006d0 <main+0x1aa>
  800548:	b59ff0ef          	jal	8000a0 <cprintf>
    
    if (safe_div(1, zero) == -1) {
  80054c:	00001697          	auipc	a3,0x1
  800550:	ab46a683          	lw	a3,-1356(a3) # 801000 <zero>
    if (b == 0) {
  800554:	ca91                	beqz	a3,800568 <main+0x42>
    return a / b;
  800556:	0016871b          	addiw	a4,a3,1
  80055a:	00373713          	sltiu	a4,a4,3
  80055e:	4781                	li	a5,0
  800560:	eb01                	bnez	a4,800570 <main+0x4a>
    if (safe_div(1, zero) == -1) {
  800562:	577d                	li	a4,-1
  800564:	00e79e63          	bne	a5,a4,800580 <main+0x5a>
        return 0;  // 成功退出
    } else {
        panic("FAIL: T.T\n");
    }
  800568:	60a2                	ld	ra,8(sp)
  80056a:	4501                	li	a0,0
  80056c:	0141                	addi	sp,sp,16
  80056e:	8082                	ret
    return a / b;
  800570:	0006879b          	sext.w	a5,a3
  800574:	b7fd                	j	800562 <main+0x3c>
  800576:	0007059b          	sext.w	a1,a4
  80057a:	b7d9                	j	800540 <main+0x1a>
        return -1;
  80057c:	55fd                	li	a1,-1
  80057e:	b7c9                	j	800540 <main+0x1a>
        panic("FAIL: T.T\n");
  800580:	00000617          	auipc	a2,0x0
  800584:	16060613          	addi	a2,a2,352 # 8006e0 <main+0x1ba>
  800588:	45d5                	li	a1,21
  80058a:	00000517          	auipc	a0,0x0
  80058e:	16650513          	addi	a0,a0,358 # 8006f0 <main+0x1ca>
  800592:	a95ff0ef          	jal	800026 <__panic>
